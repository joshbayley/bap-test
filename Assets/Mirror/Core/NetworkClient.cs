...
namespace Mirror
{
    ...
    public static partial class NetworkClient
    {
        ...
        public static readonly SortedDictionary<uint, NetworkIdentity> spawned =
            new SortedDictionary<uint, NetworkIdentity>();
        ...
        public static Action OnNetworkEarlyUpdate = () => { };
        ...
        internal static void OnTransportData(ArraySegment<byte> data, int channelId)
        {
            if (connection != null)
            {
                ...
                // int totalBatches = unbatcher.BatchesCount;
                       ...
                       unbatcher.GetNextMessage(out ArraySegment<byte> message, out double remoteTimestamp))
                {
                    ...
                    {
                        //CustomNetMonitor.RecordData(Time.frameCount, reader.Remaining, totalBatches);
        ...
        internal static void NetworkEarlyUpdate()
        {
            ...
            // Debug.Log($"[TESTMANAGER] MIRRORNETEARLYUPDATE | {Time.frameCount}");
            OnNetworkEarlyUpdate.Invoke();
        }
